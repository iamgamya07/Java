...
public class DatabaseConnection {
    ...
    public void editAttendee(Connection con, int id, String email, String contactNumber) throws SQLException {
    ...
    public static void main(String[] args) {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ConferenceManagement", "root", "Jewel@2003");
